...
const PiggyBankView = (props) => {
  ...
  return (
    <div className="my-6 mb-4 w-full border-2 border-pink-300 bg-white px-8 pt-6 pb-8 shadow-md ">
            ...
            <div
              className={
                error == "Transaction Success"
                  ? "flex w-1/3 justify-center border bg-green-400 py-1 px-4 text-3xl font-bold text-green-800"
